...
Теперь можно запускать программу, никаких дополнительных действий не требуется (если ранее у Вас была установлена предыдущая версия программы, в противном случае следуйте полной интрукции по установке)
